...
<?php
	...
	// form to selcet whdat changes should be made. 
	if (!isset($_POST['submit']) || empty($_POST['submit'])){
		...
		<div class="row">
		<div class="col-6"><label>Existing Email</label></div>
		...
		<div class="row">
		<div class="col-6"><label>Surname:</label></div>
		<div class="col-6"><input type="text" name="surname" />
		</div>

		</div>			
		</div>	
		<div class="row">
		<div class="col-6"><label>Date of birth:</label></div>
		<div class="col-6"><input type="date" name="dob" />
		</div>

		</div>	
		<div class="row">
		<div class="col-6"><label>Change Email:</label></div>
		<div class="col-6"><input type="text" name="newEmail" />
		</div>

		</div>		 
		<div class="row">
		<div class="col-6"><label>Change Password:</label></div>
		<div class="col-6"><input type="text" name="password" />
		</div>

		</div>		
		<div class="row">
		<div class="col-6"><label> Email To delete</label></div>
