	...
	if ($_GET['edit'] == 'delete') {
		...
		if ($validationResults['isValid']){
			...
			<p> Please type the name of the article you wish to delete. </p>
				...
				<div class="col-8">
				<div class="row">
				<div class="col-6"><label class="form-check-label">Article: </label></div>
				<div class="col-6"><input type="text" name="deleteArticle" class="form-label"/></div>
...
<div class="row">
<div class="col-6"><label class="form-label">New article name: </label> </div>
<div class="col-6"><input type="text" name="newArticleName" class="form-control"/></div>
<input type="submit" name="submit" value="Submit" class="btn btn-primary"/>
</div>
</div>
<div class="col-2"></div>
...
<div class="row">
<div class="col-6"><label class="form-label">New authors name: </label></div>
<div class="col-6"><input type="text" name="newArticleAuthor" class="form-control"/></div>
<input type="submit" name="submit" value="Submit" class="btn btn-primary"/>
...
<div class="col-2"></div>
	...
	if ($_GET['edit'] == 'editArticleCategory') {
		...
		// checks the fields havee been filled out. 
		...
		if ($validationResults['isValid']){
			...
			echo '<p> Please type the name of the article you wish to change. </p>
				...
				<div class="row">
				<div class="col-6"><label class="form-label">New article category: </label></div>
				<div class="col-6"> <input type="text" name="newArticleCategory" class="form-control"/></div>
				<input type="submit" name="submit" value="Submit" class="btn btn-primary"/>
...
<div class="row">
<div class="col-6"><label class="form-label">Article name: </label></div>
<div class="col-6"><input type="text" name="articleName" class="form-control" class="form-control"/></div>

</div>
<div class="row">
<div class="col-6"><label >Article content:</label></div>
<div class="col-6">					<textarea name="articleContent"></textarea>
</div>
